...
//		String prog2 = "prog2_Test";
		...
		try {
			...
			String[] cl1MsgsArr = new String[]{
					lSchedPub.get(0).getChannel().getNomIdCh()+"."+lSchedPub.get(0).getProgramme().getNomProg()};
			String[] cl2MsgsArr = new String[]{
					lSchedPub.get(1).getChannel().getNomIdCh()+"."+lSchedPub.get(1).getProgramme().getNomProg()};
